...
$filtered_id = mysqli_real_escape_string($conn, $_GET['id']); //sql 주입 공격을 막을 수 있어. --생략기호를 활용한 공격에 대비가능
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="review">
            ...
            <a href="delets.php?id=<?= $_GET['id']; ?>">리뷰 삭제</a>
            <div id="review-input">
                <form action="./delete_process.php" method="post">
                    <p><input type="hidden" name="review-id" value="<?php echo $_GET['id']; ?>"></p>
                    <p><input type="text" name="review-title" placeholder="ID를 입력하세요."></p>
